...
const tableRows = [
  { rank: "04", initials: "PH", name: "PHANTOM KNIGHTS", dept: "Fine Arts", pts: "2,450", trend: "up" },
  { rank: "05", initials: "VC", name: "VELOCITY CORES", dept: "Physics", pts: "2,280", trend: "down" },
  { rank: "06", initials: "IR", name: "IRON REBELS", dept: "Mechanical Eng", pts: "2,110", trend: "neutral" },
  { rank: "07", initials: "AL", name: "ALPHA LEGION", dept: "Humanities", pts: "1,940", trend: "up" },
  { rank: "08", initials: "NB", name: "NEBULA BLASTERS", dept: "Aerospace", pts: "1,720", trend: "up" },
];
    ...
    <div style={{ backgroundColor: "#0c0f0f", color: "#edeeed" }}>
      ...
      <main className="relative min-h-screen">
        ...
        <div
          ...
          style={{ backgroundColor: "rgba(0,227,253,0.05)", filter: "blur(120px)" }}
        />
        ...
        <section className="relative pt-16 pb-32 px-8 max-w-screen-2xl mx-auto overflow-hidden">
          <div className="flex flex-col items-center mb-20 text-center">
            ...
            >
              CHAMPIONS <br />
              <span className="neon-glow-text" style={{ color: "#d2ff9a" }}>
                OF THE ARENA
              </span>
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
            {topThree.map(
              ({ order, rank, name, dept, points, borderColor, pointColor, paddingClass, avatarSize, avatarTop, marginTop, borderWidth, img, pointsSize, isFirst }) => (
                <div key={name} className={`${order} group`}>
                  <div
                    ...
                    style={{
                      backgroundColor: isFirst ? "#1c2020" : "#111414",
                      borderBottomColor: borderColor,
                      boxShadow: isFirst ? "0 20px 60px rgba(210,255,154,0.15)" : undefined,
                    }}
                  >
                    <div className={`absolute ${avatarTop} left-1/2 -translate-x-1/2`}>
                      <div
                        className={`${avatarSize} rounded-full border-4 overflow-hidden`}
                        style={{
                          borderColor,
                          backgroundColor: "#222727",
                          boxShadow: isFirst ? `0 0 0 8px ${borderColor}1a` : undefined,
                        }}
                      >
                    ...
                    <div className={`${marginTop} text-center`}>
                      {isFirst && (
                        <div
                          ...
                          style={{ backgroundColor: "rgba(210,255,154,0.1)" }}
                        >
                          <span
                            className="w-2 h-2 rounded-full animate-pulse"
                            style={{ backgroundColor: "#d2ff9a" }}
                          />
                          <span
                      ...
                      <span
                        ...
                        style={{ fontFamily: "'Space Grotesk', sans-serif", color: pointColor }}
                      >
                        {rank}
                      </span>
                      <h3
          ...
          <div className="flex items-end justify-between mb-8">
            ...
            <div className="flex gap-4 items-center">
              <span
                ...
                style={{ fontFamily: "'Space Grotesk', sans-serif", color: "#737373" }}
              >
                Auto-update in 45s
              </span>
              <button style={{ color: "#d2ff9a" }} className="hover:text-white transition-colors">
          ...
          >
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-white/5">
                {tableRows.map(({ rank, initials, name, dept, pts, trend }) => (
                  <tr
                    key={rank}
                    ...
                    <td className="py-6 px-8">
                      <div className="flex items-center gap-4">
                        <div
                          ...
                          style={{ backgroundColor: "#222727", fontFamily: "'Space Grotesk', sans-serif" }}
                        >
                          {initials}
                        </div>
                        <span
