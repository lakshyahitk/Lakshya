      ...
      <main className="min-h-screen relative overflow-hidden">
        ...
        <div className="fixed inset-0 pointer-events-none">
          <div
            ...
            style={{ backgroundColor: "rgba(210,255,154,0.1)", filter: "blur(120px)" }}
          />
          <div
            className="absolute top-1/2 -right-24 w-80 h-80 rounded-full"
            style={{ backgroundColor: "rgba(0,227,253,0.1)", filter: "blur(100px)" }}
          />
        </div>
          ...
          <section className="mt-32 grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            >
              <div className="absolute top-0 right-0 p-4 opacity-10">
                <span className="material-symbols-outlined font-black" style={{ fontSize: "10rem" }}>
                  trophy
                </span>
              </div>
              <div className="relative z-10">
                ...
                <div className="space-y-6">
                  {[
                    { rank: "01", name: "Engineering Knights", pts: "3200 POINTS", pct: "85%", color: "#d2ff9a" },
                    { rank: "02", name: "Medicine Titans", pts: "2850 POINTS", pct: "70%", color: "#00e3fd" },
            ...
            >
              <div>
                ...
                <p className="text-sm font-semibold opacity-90">
                  Join over 5,000 athletes competing for the glory of their department.
                </p>
              </div>
              <Link
                href="/registration"
