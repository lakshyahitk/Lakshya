            ...
            <section className="relative min-h-[85vh] md:min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 pt-16 md:pt-20">
                ...
                <div className="relative z-10 text-center space-y-4 md:space-y-6">
                    <div className="flex items-center justify-center gap-2 mb-2 md:mb-4">
                        ...
                        />
                        <span
                            className="tracking-widest uppercase text-xs md:text-sm font-bold"
                            style={{
                                fontFamily: "'Space Grotesk', sans-serif",
                                color: "#ff833f",
                            }}
                    ...
                    <h1
                        className="text-6xl md:text-8xl lg:text-[7rem] font-black italic leading-[0.85] tracking-tighter mb-6 md:mb-8"
                        style={{
            ...
            <section className="max-w-screen-2xl mx-auto px-6 md:px-8 py-16 md:py-24">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-16 gap-6 md:gap-4">
                    <div className="max-w-xl md:max-w-2xl">
                        <h2
                            className="text-4xl md:text-6xl lg:text-7xl font-black uppercase italic tracking-tighter mb-4"
                        ...
                        >
                            Whether you&apos;re a powerhouse on the court or a
                            strategist on the field, there&apos;s a legend
                            waiting to be born.
                        </p>
                    </div>
                    <Link
                        href="/sports"
                        className="flex items-center gap-2 uppercase tracking-widest text-xs md:text-sm font-bold transition-all hover:gap-4"
                        style={{
                            fontFamily: "'Space Grotesk', sans-serif",
                            color: "#00e3fd",
                        }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 h-[600px] md:h-[700px] lg:h-[800px]">
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 p-6 md:p-8 z-20 w-full">
                            <span
                                className="px-3 py-1 md:px-4 md:py-1 text-[10px] md:text-xs font-bold uppercase tracking-widest rounded-full mb-3 md:mb-4 inline-block"
                                style={{
                                    backgroundColor: "#d2ff9a",
                                    color: "#3d6500",
                                    fontFamily: "'Space Grotesk', sans-serif",
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 sm:gap-0">
                                <p className="text-white/70 max-w-sm font-medium text-sm md:text-base">
                                    11 vs 11 Knockout Tournament. National
                                    scouts in attendance for the final.
                                </p>
                                <button className="bg-white text-black p-3 md:p-4 rounded-full active:scale-90 transition-transform">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
                        <div className="flex-1 space-y-6">
                            ...
                            <p style={{ color: "#a9abab" }} className="text-lg">
                                Registration is open until May 1st, 2026. Groups
                                of 10 or more receive a 20% early bird discount.
                            </p>
